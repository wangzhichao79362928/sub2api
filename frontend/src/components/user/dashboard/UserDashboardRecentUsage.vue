  ...
  <div class="dashboard-card overflow-hidden">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="dashboard-muted-panel flex items-center justify-between gap-4 p-4 transition-colors hover:bg-primary-50/60 dark:hover:bg-dark-800">
