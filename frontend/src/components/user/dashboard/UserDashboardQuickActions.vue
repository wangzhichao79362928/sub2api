<template>
  <div class="dashboard-card overflow-hidden">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="dashboard-muted-panel group flex w-full items-center gap-4 p-4 text-left transition-all duration-200 hover:bg-primary-50/70 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/usage')" class="dashboard-muted-panel group flex w-full items-center gap-4 p-4 text-left transition-all duration-200 hover:bg-emerald-50/70 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/redeem')" class="dashboard-muted-panel group flex w-full items-center gap-4 p-4 text-left transition-all duration-200 hover:bg-amber-50/70 dark:hover:bg-dark-800">
